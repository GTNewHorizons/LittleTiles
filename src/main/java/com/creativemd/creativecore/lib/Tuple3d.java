...
/*     */ {
    ...
    /*     */ {
        ...
        /* 380 */ if ((d < 0.0D ? -d : d) > paramDouble) {
            return false;
            /*     */ }
        /* 382 */ d = this.y - paramTuple3d.y;
        /* 383 */ if ((d < 0.0D ? -d : d) > paramDouble) {
            return false;
            /*     */ }
        /* 385 */ d = this.z - paramTuple3d.z;
        /* 386 */ if ((d < 0.0D ? -d : d) > paramDouble) {
            return false;
            /*     */ }
        /* 388 */ return true;
        /*     */ }
...
/*
 * Location:
 * C:\Users\CMD\.gradle\caches\modules-2\files-2.1\java3d\vecmath\1.3.1\a0ae4f51da409fa0c20fa0ca59e6bbc9413ae71d\vecmath
 * -1.3.1.jar Qualified Name: javax.vecmath.Tuple3d Java Class Version: 1.2 (46.0) JD-Core Version: 0.7.0.1
 */
